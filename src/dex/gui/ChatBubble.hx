...
class ChatBubble {
	public var onObject(default, null):HashOrUrl;
	...
	public function new(chatBubbleTree:Map<Hash, GuiNode>, texts:Map<Hash, String>, onObject:HashOrUrl, duration:Int, instant:Bool,
